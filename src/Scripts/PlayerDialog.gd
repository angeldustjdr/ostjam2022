...
func _process(delta):
	...
	var openingDialog = ["WTF happened ?","Why am I still alive ?","I gotta find out.","I gotta keep moving !","("+keyboard+" to move)","(Left click to shoot)","(Space to dash)", "(Dashing damages the enemies upon landing)"]
